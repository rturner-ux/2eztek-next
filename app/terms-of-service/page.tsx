    ...
    <main className="min-h-screen bg-white px-6 py-32 text-slate-900 lg:px-16">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mt-12 space-y-10 leading-8 text-slate-600">
          ...
          <section>
            <h2 className="mb-4 text-2xl font-black text-slate-900">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="mb-4 text-2xl font-black text-slate-900">2. Services</h2>
          ...
          <section>
            <h2 className="mb-4 text-2xl font-black text-slate-900">3. Service Requests and Appointments</h2>
          ...
          <section>
            <h2 className="mb-4 text-2xl font-black text-slate-900">4. Pricing and Payment</h2>
          ...
          <section>
            <h2 className="mb-4 text-2xl font-black text-slate-900">5. Workmanship Warranty</h2>
          ...
          <section>
            <h2 className="mb-4 text-2xl font-black text-slate-900">6. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="mb-4 text-2xl font-black text-slate-900">7. Customer Responsibilities</h2>
          ...
          <section>
            <h2 className="mb-4 text-2xl font-black text-slate-900">8. Intellectual Property</h2>
          ...
          <section>
            <h2 className="mb-4 text-2xl font-black text-slate-900">9. Third-Party Links</h2>
          ...
          <section>
            <h2 className="mb-4 text-2xl font-black text-slate-900">10. Governing Law</h2>
          ...
          <section>
            <h2 className="mb-4 text-2xl font-black text-slate-900">11. Changes to Terms</h2>
          ...
          <section>
            <h2 className="mb-4 text-2xl font-black text-slate-900">12. Contact</h2>
        ...
        <div className="mt-16 flex flex-wrap gap-4">
          <Link href="/privacy-policy" className="rounded-2xl border border-slate-200 bg-white px-6 py-4 text-sm font-black uppercase tracking-[0.12em] text-slate-700 shadow-sm transition hover:border-cyan-300 hover:bg-cyan-50">
            Privacy Policy
          </Link>
