...
export const metadata = {
  ...
  description:
    'Commercial gym maintenance services for fitness centers, apartments, hotels, schools, and training facilities across Dallas Fort Worth.',
}
        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-4xl">
            ...
            <p className="mt-8 max-w-2xl text-lg leading-8 text-white/88 md:text-xl">
              Professional commercial gym maintenance services for fitness
              facilities across Dallas Fort Worth. Reduce downtime and keep
              your members satisfied.
            </p>
      ...
      <section className="relative z-10 px-6 py-24 lg:px-16">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-16 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {maintenancePrograms.map((service) => (
              <div
                key={service}
              ...
              >
                ...
                <div className="relative">
                  ...
                  <p className="mt-5 leading-8 text-white/80">
                    Professional servicing and preventative maintenance
                    solutions to help minimize equipment downtime.
                  </p>
                </div>
              </div>
            ))}
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr,360px] lg:items-center">
            <div>
              ...
              <p className="mt-7 max-w-2xl text-lg leading-8 text-white/80">
                2EZ TEK provides commercial maintenance programs tailored
                for gyms, apartments, hotels, and fitness facilities across
                Dallas Fort Worth.
              </p>
            </div>
