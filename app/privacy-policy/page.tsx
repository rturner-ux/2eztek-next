    ...
    <main className="min-h-screen bg-[#050B14] text-white px-6 py-32 lg:px-16">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mt-12 space-y-10 text-white/70 leading-8">
          ...
          <section>
            <h2 className="text-2xl font-black text-white mb-4">1. Overview</h2>
          ...
          <section>
            <h2 className="text-2xl font-black text-white mb-4">2. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-2xl font-black text-white mb-4">3. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-2xl font-black text-white mb-4">4. Information Sharing</h2>
          ...
          <section>
            <h2 className="text-2xl font-black text-white mb-4">6. Cookies and Analytics</h2>
          ...
          <section>
            ...
            <p className="mt-4">To exercise any of these rights, contact us at <a href="mailto:support@2eztek.com" className="text-cyan-400 hover:underline">support@2eztek.com</a>.</p>
          </section>

          <section>
            <h2 className="text-2xl font-black text-white mb-4">8. Security</h2>
        ...
        <div className="mt-16 flex flex-wrap gap-4">
          <Link href="/terms-of-service" className="rounded-2xl border border-white/10 bg-white/5 px-6 py-4 text-sm font-black uppercase tracking-[0.12em] text-white transition hover:border-cyan-400/30 hover:bg-cyan-400/10">
            Terms of Service
          </Link>
