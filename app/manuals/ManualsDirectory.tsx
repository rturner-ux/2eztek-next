    ...
    <section className="mx-auto max-w-7xl px-6 py-20">
      <div className="mb-10">
        ...
        <p className="mt-4 max-w-4xl text-lg leading-8 text-white/60">
          Search fitness equipment manuals, service documentation, exploded diagrams,
          troubleshooting guides, and assembly references by brand, model, or equipment type.
        </p>
      </div>
      ...
      {!hasActiveSearch && (
        <div className="mt-10 rounded-[2rem] border border-white/10 bg-white/5 p-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl leading-8 text-white/60">
            Manuals remain hidden until a search or filter is selected. Search by brand,
            model, or equipment type to access the SmartGymOps equipment library.
          </p>
        </div>
      )}
          ...
          {filtered.map((manual) => (
            ...
            >
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <a
                  href={buildBrandedManualUrl(manual)}
                  target="_blank"
