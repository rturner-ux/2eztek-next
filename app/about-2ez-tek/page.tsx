        ...
        >
          <div className="max-w-5xl">
            ...
            >
              ...
              installation, relocation, and preventative maintenance across Dallas
              Fort Worth — backed by SmartGymOps-powered tracking and operational visibility.
            </motion.p>
                ...
                {timeline.map((item, i) => (
                  <div key={item.year} className="flex gap-5">
                    <div className="flex flex-col items-center">
                      <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full border border-cyan-400/30 bg-cyan-400/10 text-xs font-black text-cyan-400">
                        {i + 1}
                      </div>
                      {i < timeline.length - 1 && (
        ...
        <div className="mx-auto max-w-7xl">
          <Reveal className="mb-14 max-w-3xl">
            ...
            <p className="mt-6 text-lg leading-relaxed text-white/60">
              Our work covers the full spectrum of fitness equipment service — repair, assembly, maintenance, and installation for residential and commercial clients across DFW.
            </p>
          </Reveal>
          ...
          >
            {services.map((service, i) => (
              <motion.div
                ...
                className="rounded-3xl border border-white/10 bg-white/[0.05] p-7 transition-all duration-300 hover:border-cyan-400/25 hover:bg-cyan-400/[0.04]"
              >
            ...
            >
              {values.map((v) => (
                <motion.div
                  ...
                  whileHover={{ x: 6 }}
                  transition={{ duration: 0.3, ease: EASE }}
                  className="flex items-start gap-5 rounded-3xl border border-white/10 bg-white/[0.05] p-6 transition-all duration-300 hover:border-cyan-400/25"
                >
                  <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-2xl border border-cyan-400/20 bg-cyan-400/10 text-xl">
                    {v.icon}
                  </div>
                  <div>
      ...
      <section className="border-t border-white/10 bg-[#050B14] px-6 py-28 lg:px-16">
        <div className="mx-auto max-w-7xl">
          <Reveal className="text-center max-w-3xl mx-auto mb-14">
            ...
            <p className="mt-6 text-lg leading-relaxed text-white/60">
              From Addison to Arlington, Frisco to Fort Worth — 2EZ TEK covers the full DFW metroplex for residential and commercial fitness equipment service.
            </p>
          </Reveal>

          <Reveal delay={0.2} className="flex flex-wrap justify-center gap-3">
            {['Dallas', 'Fort Worth', 'Plano', 'Frisco', 'Irving', 'Arlington', 'Richardson', 'McKinney', 'Garland', 'Mesquite', 'Carrollton', 'Addison'].map((area) => (
              <Link
                key={area}
                href={'/areas/' + area.toLowerCase().replace(' ', '-')}
                className="rounded-2xl border border-white/10 bg-white/[0.05] px-5 py-3 text-sm font-black uppercase tracking-[0.14em] text-white/65 transition hover:border-cyan-400/30 hover:bg-cyan-400/[0.05] hover:text-cyan-300"
              >
                {area}
              </Link>
            ))}
      ...
      <section className="relative overflow-hidden border-t border-white/10 bg-[#070B12] px-6 py-32 text-center lg:px-16">
        ...
        <Reveal className="relative z-10 mx-auto max-w-4xl">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-white/60">
            Whether you need a single repair or a full commercial maintenance program, our team is ready to help across Dallas Fort Worth.
          </p>
