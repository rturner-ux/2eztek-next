...
const POPULAR_TOPICS = [
  ...
  { brand: 'Rogue Fitness', issue: 'Monster Lite RML-490 assembly leveling', equipment: 'power rack' },
  { brand: 'Rogue Fitness', issue: 'SML-1 squat stand stability and footprint anchoring', equipment: 'squat stand' },
  { brand: 'Rogue Fitness', issue: 'Echo Bike assembly handle post torque', equipment: 'assault bike' },
  { brand: 'Rogue Fitness', issue: 'Monster RM-6 base plate and upright alignment', equipment: 'power rack' },
  { brand: 'Rogue Fitness', issue: 'Infinity Series cable pulley and lat tower setup', equipment: 'cable machine' },
  { brand: 'Rogue Fitness', issue: 'garage gym floor anchor and stud locating', equipment: 'power rack' },
  ...
  { brand: 'PRX Performance', issue: 'Profile Series stud spacing and concrete alternative', equipment: 'squat rack' },
  { brand: 'PRX Performance', issue: 'weight storage peg installation and load capacity', equipment: 'squat rack' },
  { brand: 'PRX Performance', issue: 'pull-up bar attachment alignment after fold', equipment: 'squat rack' },
  { brand: 'PRX Performance', issue: 'Shorty rack ceiling clearance and hinge adjustment', equipment: 'squat rack' },
  // Matrix
