  ...
  <div style="font-family:Arial,sans-serif;background:#f8fafc;padding:32px 16px;">
    <div style="max-width:560px;margin:0 auto;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 2px 16px rgba(0,0,0,0.08);">
      ...
      <div style="padding:32px;">
        <h2 style="margin:0 0 8px;font-size:22px;font-weight:900;color:#0f172a;">We got your message, ${firstName}!</h2>
        <p style="margin:0 0 24px;font-size:15px;color:#475569;line-height:1.7;">
          ${service
            ? `You reached out about <strong>${service}</strong>. Our team will call you within the hour to get you scheduled.`
